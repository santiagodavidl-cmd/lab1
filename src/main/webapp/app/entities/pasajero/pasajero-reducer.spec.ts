...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './pasajero.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PASAJERO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PASAJERO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PASAJERO actions', async () => {
      const arg = { id: 13619 };
    ...
    it('dispatches UPDATE_PASAJERO actions', async () => {
      const arg = { id: 13619 };
    ...
    it('dispatches PARTIAL_UPDATE_PASAJERO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PASAJERO actions', async () => {
      const arg = 42666;
