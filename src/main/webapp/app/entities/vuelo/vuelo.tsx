      ...
      <div className="table-responsive">
        {vueloList?.length > 0 ? (
          <Table responsive>
            ...
            <tbody>
              {vueloList.map(vuelo => (
                <tr key={`entity-${vuelo.id}`} data-cy="entityTable">
                  <td>
                    <Button as={Link as any} to={`/vuelo/${vuelo.id}`} variant="link" size="sm">
                      {vuelo.id}
                    </Button>
                  </td>
                  ...
                  <td>{vuelo.precio}</td>
                  <td>{vuelo.avion ? <Link to={`/avion/${vuelo.avion.id}`}>{vuelo.avion.matricula}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button as={Link as any} to={`/vuelo/${vuelo.id}`} variant="info" size="sm" data-cy="entityDetailsButton">
