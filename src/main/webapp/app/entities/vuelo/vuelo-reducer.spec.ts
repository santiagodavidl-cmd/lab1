...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './vuelo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VUELO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VUELO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VUELO actions', async () => {
      const arg = { id: 26877 };
    ...
    it('dispatches UPDATE_VUELO actions', async () => {
      const arg = { id: 26877 };
    ...
    it('dispatches PARTIAL_UPDATE_VUELO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VUELO actions', async () => {
      const arg = 42666;
