...
import static com.udea.proyecto.domain.PasajeroAsserts.*;
...
class PasajeroResourceIT {
    ...
    public static Pasajero createEntity() {
        return new Pasajero().nombre(DEFAULT_NOMBRE).apellido(DEFAULT_APELLIDO).documento(DEFAULT_DOCUMENTO).email(DEFAULT_EMAIL);
    }
    ...
    public static Pasajero createUpdatedEntity() {
        return new Pasajero().nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).documento(UPDATED_DOCUMENTO).email(UPDATED_EMAIL);
    }
    ...
    void putExistingPasajero() throws Exception {
        ...
        updatedPasajero.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).documento(UPDATED_DOCUMENTO).email(UPDATED_EMAIL);
    ...
    void fullUpdatePasajeroWithPatch() throws Exception {
        ...
        partialUpdatedPasajero.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).documento(UPDATED_DOCUMENTO).email(UPDATED_EMAIL);
